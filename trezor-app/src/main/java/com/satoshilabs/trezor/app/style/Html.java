...
public class Html {
    ...
    protected boolean handleTag(boolean opening, String tag, Attributes attributes, Editable output, XMLReader xmlReader) {
    	return false;
    }
}
...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    protected void handleStartTag(String tag, Attributes attributes) {
    	if (mTagHandler != null && mTagHandler.handleStartTag(tag, attributes, mSpannableStringBuilder, mReader)) {
    		// 
    	}
    ...
    private static void end(SpannableStringBuilder text, @SuppressWarnings("rawtypes") Class kind,
                            Object repl) {
        int len = text.length();
