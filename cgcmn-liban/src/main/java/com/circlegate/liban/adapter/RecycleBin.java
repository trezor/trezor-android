...
public class RecycleBin {
    ...
    private SparseArrayCompat<View>[] scrapViews;
    ...
    public void setViewTypeCount(int viewTypeCount) {
        ...
        SparseArrayCompat<View>[] scrapViews = new SparseArrayCompat[viewTypeCount];
        for (int i = 0; i < viewTypeCount; i++) {
            scrapViews[i] = new SparseArrayCompat<View>();
        }
    ...
    void scrapActiveViews() {
        ...
        SparseArrayCompat<View> scrapViews = currentScrapViews;
    ...
    private void pruneScrapViews() {
        ...
        final SparseArrayCompat<View>[] scrapViews = this.scrapViews;
        for (int i = 0; i < viewTypeCount; ++i) {
    ...
    static View retrieveFromScrap(SparseArrayCompat<View> scrapViews, int position) {
