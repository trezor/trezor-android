...
public class PaddedRelativeLayout extends RelativeLayout {
    ...
    public PaddedRelativeLayout(Context context) {
        this(context, null);
    }

    public PaddedRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PaddedRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
